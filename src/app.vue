...
!(function() {
  var t = {
    ...
    opt_out_setup: function() {
      this.register_opt_out_listener(".__alx_opt_out_class", function(n) {
        "function" == typeof n.preventDefault && n.preventDefault(),
          t.sbc(t.opt_out_class, "true", 31536e4);
      }),
        this.register_opt_out_listener(".__alx_opt_in_class", function(n) {
          "function" == typeof n.preventDefault && n.preventDefault(),
            t.sbc(t.opt_out_class, "true", 1);
        });
    },
    register_opt_out_listener: function(t, n) {
      for (var e = document.querySelectorAll(t), r = 0; r < e.length; r++) {
        ...
        "function" == typeof o.addEventListener
          ...
          : "function" == typeof o.attachEvent && o.attachEvent("onclick", n);
      }
    },
    fired: function() {
      return (
        void 0 === window._atrk_fired && (window._atrk_fired = !1),
        window._atrk_fired
      );
    },
    params: {
      ...
      java_enabled: function() {
        return navigator && void 0 !== navigator.javaEnabled
          ? navigator.javaEnabled() ? "1" : "0"
          : "";
      },
      cookie_enabled: function() {
        return navigator && void 0 !== navigator.cookieEnabled
          ? navigator.cookieEnabled ? "1" : "0"
          : "";
      },
      ref_url: function() {
        return "string" == typeof document.referrer
          ? t.ue(document.referrer)
          : "";
      },
      host_url: function() {
        return "string" == typeof window.location.href
          ? t.ue(window.location.href)
          : "";
      },
      ...
      account: function() {
        return "string" == typeof this.opts.atrk_acct
          ? this.opts.atrk_acct
          : "";
      },
      jsv: function() {
    ...
    gbc: function(t) {
      ...
      return (
        -1 == (n = e.indexOf(";", o)) && (n = e.length),
        this.ue(e.substring(o + r.length, n))
      );
    },
    sbc: function(t, n, e) {
      var r = new Date(),
        o = this.dom();
      r.setTime(r.getTime() + 1e3 * e),
        (document.cookie =
          t +
          "=" +
          escape(n) +
          (e ? "; expires=" + r.toGMTString() : "") +
          (o && o.length > 0 ? "; domain=." + o : "") +
          "; path=/");
    },
    dom: function() {
    ...
    gen_url: function() {
      try {
        ...
        return (
          this.iu +
          this.map(this.params, function(n, e) {
            return n + "=" + e.call(t);
          }).join("&")
        );
      } catch (t) {
  ...
  (window.atrk = function() {
    ...
    "undefined" != typeof _atrk_opts &&
      void 0 !== _atrk_opts.dynamic &&
      _atrk_opts.dynamic &&
      atrk();
})();
</script>
